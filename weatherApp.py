...
st.markdown("<h1 style = 'color: #79ba6a'>WEATHER PREDICTION APP</h1> ", unsafe_allow_html = True)
st.markdown("<h6 style = 'top_margin: 0rem;color: #5d6941'>Built by GoMyCode Prospective Data Scientists</h6>", unsafe_allow_html = True)
st.image('img03.png', width =500)
